...
import { parseRectFragment, getRectSize } from './selectors/RectFragment';
...
export default class AnnotationLayer extends EventEmitter {
  ...
  deselect = skipRedraw => {
    ...
    if (this.selectedShape) {
      ...
      //this.emit('deselectAnnotation', {annotation});
    }
  ...
  getRectSize = g => {
    return getRectSize(g);
  }
  /*Useless custom function
  parseRect = annotation => {
    return parseRectFragment(annotation);
  }
  */
