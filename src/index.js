...
export class Annotorious {
  ...
  handleDeSelectAnnotation = () => {
    //this._emitter.emit('deselectAnnotation');
  }
  ...
  selectAnnotation = annotationOrId => {
    const arg = (annotationOrId?.type === 'Annotation') ? 
      ...
      //this._emitter.emit('myEvent', evt);
  ...
  findAnnotationSVG = (annotation) => {
    return this._app.current.findAnnotationSVG(annotation);
  }

  getRectSize = (annotation) => {
   
    return this._app.current.getRect(annotation);
  }

  /*
  parseRect = (annotation) => {
    return this._app.current.parseRect(annotation);
  }
  */
  ...
  //custom function
  deSelect = () => {
   // return this._app.current.deselect();
